 ...
 * @author nandan
 */
public class GithubSearchResultOverview extends javax.swing.JFrame {

    /**
     * Creates new form GithubSearchResultOverview
     */
    Connection con;
    org.eclipse.egit.github.core.User user;
    GitHubClient github;

    public GithubSearchResultOverview(Connection con, org.eclipse.egit.github.core.User user, GitHubClient github) {
        this.con = con;
        this.user = user;
        this.github = github;
        initComponents();
        jLabel5.setText(user.getName());
        jLabel6.setText("@" + user.getLogin());
        jLabel7.setText(user.getFollowers() + "");
        jLabel9.setText(user.getLocation());
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("No. of followers:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, -1, -1));
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(43, 39, 86, 81));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 100, -1, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                javax.swing.JFrame setupChooserFrame = new GithubSetupChooser(con, user, github);
